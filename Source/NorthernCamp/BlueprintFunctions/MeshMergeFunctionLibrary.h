...
//--------------------------------------------------------------------------------------------------------------------------------------------
// So basicaly i need this to get a bunch of skeletal meshes together.
// I have mostly no idea whats happening here since the whole class is copied form epics offical documentation for merging skeletal meshes.
//--------------------------------------------------------------------------------------------------------------------------------------------
...
struct NORTHERNCAMP_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NORTHERNCAMP_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NORTHERNCAMP_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NORTHERNCAMP_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class NORTHERNCAMP_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
